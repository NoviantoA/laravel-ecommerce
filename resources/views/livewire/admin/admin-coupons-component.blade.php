                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('admin.addcoupon')}}" class="btn btn-success pull-right">Tambah</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#"
                                            onclick="confirm('Apakah Anda Yakin Ingin Menghapus Kupon Ini') || event.stopImmediatePropagation()"
