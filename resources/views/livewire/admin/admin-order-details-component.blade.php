            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                Details Barang yang Dipesan
                            </div>
                            <div class="col-md-6">
                                <a href="{{route('admin.orders')}}" class="btn btn-success pull-right">Semua Order</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="summary">
                            <div class="order-summary">
                                ...
                                <p class="summary-info"><span class="title">Subtotal</span><b
                                        class="index">Rp{{$order->subtotal}}</b></p>
                                <p class="summary-info"><span class="title">Biaya Ongkos Kirim</span><b
                                ...
                                <p class="summary-info"><span class="title">Total</span><b
                                        class="index">Rp{{$order->total}}</b></p>
                            </div>
                        </div>
                    </div>
                </div>
