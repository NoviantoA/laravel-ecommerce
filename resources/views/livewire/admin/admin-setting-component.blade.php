            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" wire:submit.prevent="saveSetings">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Nomor Telephon</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Nomor Telephon" class="form-control input-md"
                                        wire:model="phone">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Nomor Telephon Ke-2</label>
                                <div class="col-md-4">
                                    <input type="text" placeholder="Nomor Telephon Ke-2" class="form-control input-md"
                                        wire:model="phone2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Alamat" class="form-control input-md"
                                        wire:model="address">
