	            ...
	            <div class=" main-content-area">
	                ...
	                <div class="wrap-iten-in-cart">
	                    ...
	                    <div class="alert alert-success">
	                        <strong>Sukes</strong> {{Session::get('success_message')}}
	                    </div>
	                    @endif
	                        ...
	                        <li class="pr-cart-item">
	                            ...
	                            <div class="product-name">
	                                <a class="link-to-product"
	                                    href="{{route('product.delails',['slug'=>$item->model->slug])}}">{{$item->model->name}}</a>
	                            </div>
	                            ...
	                            <div class="quantity">
	                                ...
	                                <p class="text-center"><a href="#"
	                                        wire:click.prevent="switchToSaveForLater('{{$item->rowId}}')">Simpan
	                                        untuk nanti</a></p>
	                            </div>
	                ...
	                <div class="summary">
	                    <div class="order-summary">
	                        <h4 class="title-box">Rangkuman Pesanan</h4>
	                        <p class="summary-info"><span class="title">Subtotal</span><b class="index">Rp
	                                {{Cart::instance('cart')->subtotal()}}</b></p>
	                        @if(Session::has('coupon'))
	                        <p class="summary-info"><span class="title">Diskon
	                                ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeCoupon"><i
	                                        class="fa fa-times text-danger"></i></a></span><b class="index">Rp
	                                {{number_format($discount,2)}}</b></p>
	                        <p class="summary-info"><span class="title">Subtotal Dengan Diskon
	                            </span><b class="index"> -Rp {{number_format($subtotalAfterDiscount,2)}}</b></p>
	                        <p class="summary-info"><span class="title"> Biaya Ongkos Kirim ({{config('cart.tax')}}%)
	                    ...
	                    <div class="checkout-info">
	                        ...
	                        <label class="checkbox-field">
	                            <input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox"
	                                wire:model="haveCouponCode"><span>Memiliki Kupon</span>
	                        </label>
	                        @if($haveCouponCode == 1)
	                        <div class="summary-item">
	                            <form wire:submit.prevent="applyCouponCode">
	                                ...
	                                @endif
	                                <p class="row-in-form">
	                                    <label for="coupon-code">Masukan Kode Kupon Anda : </label>
	                        ...
	                        <a class="link-to-shop" href="shop.html">Lanjutkan Belanja<i class="fa fa-arrow-circle-right"
	                ...
	                <div class="text-center" style="padding: 30px 0;">
	                    <h1>Upss Keranjang Anda Kosong!!</h1>
	                    <p>Tambah Item Untuk Keranjang Anda Sekarang</p>
	                ...
	                <div class="wrap-iten-in-cart">
	                    <h3 class="title-box" style="border-bottom: 1px solid; padding-bottom: 15px;">
	                        {{Cart::instance('saveForLater')->count()}} Item Simpan Untuk Nanti
	                    </h3>
	                    @if (Session::has('s_success_message'))
	                    <div class="alert alert-success">
	                        <strong>Sukes</strong> {{Session::get('s_success_message')}}
	                    </div>
	                    @endif
	                    ...
	                    <ul class="products-cart">
	                        ...
	                        <li class="pr-cart-item">
	                            ...
	                            <div class="quantity">
	                                <p class="text-center"><a href="#"
	                                        wire:click.prevent="moveToCart('{{$item->rowId}}')">Pindah Ke
	                                        Keranjang</a></p>
	                            </div>
	                            <div class="delete">
	                                <a href="#" wire:click.prevent="deleteFromSaveForLater('{{$item->rowId}}')"
	                                    class="btn btn-delete" title="">
	                                    <span>Hapus dari simpan untuk nanti</span>
	                                    <i class="fa fa-times-circle" aria-hidden="true"></i>
	                                </a>
	                            </div>
	                        </li>
	                    ...
	                    @else
	                    <p>Tidak ada item untuk disimpan nanti</p>
	                    @endif
	                </div>

	                <div class="wrap-show-advance-info-box style-1 box-in-site">
	                    <h3 class="title-box">Produk yang Paling Banyak Dilihat</h3>
	                        ...
	                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
	                            ...
	                            <div class="product product-style-2 equal-elem ">
	                                <div class="product-thumnail">
	                                    ...
	                                    <div class="wrap-btn">
	                                        <a href="#" class="function-link">Lihat Sekilas</a>
	                                    </div>
	                                </div>
