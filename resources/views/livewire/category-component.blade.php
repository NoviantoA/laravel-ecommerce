            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                    ...
                    <div class="wrap-pagination-info">
                        <!-- perlu merefres dulu agar productnya muncul -->
                        {{$products->links()}}
                        <!-- <ul class="page-numbers">

	                        <li><span class="page-number-item current">1</span></li>
	                        <li><a class="page-number-item" href="shop?page=2">2</a></li>
	                        <li><a class="page-number-item" href="shop?page=3">3</a></li>
                        ...
                        <div class="widget-content">
                            <ul class="list-style vertical-list list-limited" data-show="6">
                                ...
                                <li class="list-item"><a
                                        ...
                                        class="btn-control control-show-more" href="#">Lihat Lebih Banyak<i
