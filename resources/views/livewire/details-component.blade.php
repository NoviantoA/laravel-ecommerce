	            ...
	            <div class="row">
	                ...
	                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
	                    <div class="wrap-product-detail">
	                        ...
	                        <div class="detail-info">
	                            ...
	                            @else
	                            <div class="wrap-price"><span class="product-price">Rp {{$product->regular_price}}</span>
	                            </div>
	                            @endif
	                            <div class="stock-info in-stock">
	                                <p class="availability">Ketersediaan: <b>{{$product->stock_status}}</b></p>
	                            </div>
	                            <div class="quantity">
	                                <span>Jumlah:</span>
	                            ...
	                            <div class="wrap-butons">
	                                ...
	                                <a href="#" class="btn add-to-cart"
	                                    wire:click.prevent="store({{$product->id}},'{{$product->name}}', {{$product->regular_price}} )">Tambah
	                                    ke Keranjang</a>
	                                @else
	                                <a href="#" class="btn add-to-cart"
	                                    wire:click.prevent="store({{$product->id}},'{{$product->name}}', {{$product->regular_price}} )">Tambah
	                                ...
	                                @endif
	                                <div class="wrap-btn">
	                                    <a href="#" class="btn btn-compare">Tambah Compare</a>
	                                    <a href="#" class="btn btn-wishlist">Tambah Wishlist</a>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="advance-info">
	                            <div class="tab-control normal">
	                                ...
	                                <a href="#review" class="tab-control-item">Review</a>
	                            </div>
	                                                    ...
	                                                    <div id="comment-20" class="comment_container">
	                                                        ...
	                                                        <div class="comment-text">
	                                                            <div class="star-rating">
	                                                                <span
	                                                                    class="width-{{  $orderItem->review->rating * 20 }}-percent">Dinilai
	                                                                    <strong
	                            ...
	                            <ul class="our-services">
	                                ...
	                                <li class="service">
	                                    <a class="link-to-service" href="#">
	                                        ...
	                                        <div class="right-content">
	                                            <b class="title">Gratis Ongkos Kirim</b>
	                                            <span class="subtitle">Pada Pesanan > 1 jt</span>
	                                ...
	                                <li class="service">
	                                    <a class="link-to-service" href="#">
	                                        ...
	                                        <div class="right-content">
	                                            <b class="title">Penawaran Spesial</b>
	                                ...
	                                <li class="service">
	                                    <a class="link-to-service" href="#">
	                                        ...
	                                        <div class="right-content">
	                                            <b class="title">Pengembalian Produk</b>
	                                            <span class="subtitle">Barang tidak sesuai ekspetasi anda</span>
	                                            <p class="desc">Lorem Ipsum is simply dummy text of the printing...</p>
	                                        </div>
	                                    </a>
	                                </li>
	                                ...
	                                <li class="product-item">
	                                    <div class="product product-widget-style">
	                                        <div class="thumbnnail">
	                                            <a href="{{route('product.delails',['slug'=>$p_product->slug])}}"
	                ...
	                <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                    <div class="wrap-show-advance-info-box style-1 box-in-site">
	                        <h3 class="title-box">Produk-produk Terkait</h3>
	                            ...
	                            <div class="products slide-carousel owl-carousel style-nav-1 equal-container"
	                                ...
	                                <div class="product product-style-2 equal-elem ">
	                                    <div class="product-thumnail">
	                                        <a href="{{route('product.delails',['slug'=>$r_product->slug])}}"
