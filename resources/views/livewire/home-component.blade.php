            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        ...
                        <p class="sale-info">Harga Hanya: <span class="price">Rp {{$slide->price}}</span></p>
                        <a href="{{$slide->link}}" class="btn-link">Belanja Sekarang</a>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="wrap-banner style-twin-default">
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="{{ asset('assets/images/2-fashion-banner-2.jpg') }}" alt="" width="580"
                            height="190">
                    </figure>
                </a>
            </div>
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5"
                ...
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{route('product.delails',['slug'=>$product->slug])}}" title="{{$product->name}}">
                    ...
                    <div class="product-info">
                        <a href="{{route('product.delails',['slug'=>$product->slug])}}"
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/3-fashion-banner-1.jpg') }}" width="1170" height="240"
                            alt="">
                    </figure>
                </a>
            </div>
                    ...
                    <div class="tab-contents">
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.delails',['slug'=>$lproduct->slug])}}"
                                            title="{{$lproduct->name}}">
                                            <figure><img
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">Rp
                                                {{$lproduct->regular_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item {{$key==0 ? 'active':''}}" id="category_{{$category->id}}">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.delails',['slug'=>$c_product->slug])}}"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">Rp
                                                {{$c_product->regular_price}}</span></div>
                                    </div>
                                </div>
                                @endforeach
