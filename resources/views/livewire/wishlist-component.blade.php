<main id="main" class="main-site left-sidebar">
    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <li class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        <div class="product-thumnail">
                            <a href="{{route('product.delails',['slug'=>$item->model->slug])}}"
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><span class="product-price">Rp
                                    {{$item->model->regular_price}}</span>
                            </div>
                            <a href="#" class="btn add-to-cart"
                                wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')">Pindah ke
                                Keranjang</a>
            ...
            @else
            <h4>Tidak ada item didalam wishlist</h4>
            @endif
        </div>
    </div>
</main>